  ...
  return (
    <div className='wrapper pb-[40px]'>
      ...
      <div className='flex items-center gap-x-4 mb-[50px]'>
        ...
        <h3 className='text-[28px] font-bold'>Categories For Men</h3>
      </div>
            <div className='grid grid-cols-4 w-full max-[786px]:grid-cols-2 max-[480px]:grid-cols-1'>
              {Men.map((item)=> (
                <Link to={ `/products/${item.id}?category=Men`}>
                  <div className='mb-10 '>
