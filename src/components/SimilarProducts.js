        ...
        <div className='grid grid-cols-4 w-full max-[768px]:grid-cols-2 max-[480px]:grid-cols-1 '>
              {limelight.map((item)=> (
                  <div className='mb-10'>
                    ...
                    <div className='flex justify-between items-center w-[271px] max-[1280px]:w-[260px] max-[1080px]:w-[200px] max-[980px]:w-[150px] max-[768px]:w-[250px] max-[640px]:w-[200px] max-[640px]:block max-[480px]:w-full'>
                      ...
                      <div className='bg-[#F6F6F6] p-2 rounded-[5px] max-[640px]:w-[70px] '>
